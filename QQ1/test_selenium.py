...
class TestTestcase():
    ...
    def test_wx(self):
        ...
        # sleep(5)
        # self.driver.find_element((By.XPATH, '//*[@id="https://work.weixin.qq.com/wework_admin/frame"]/div/div[2]/div/div[2]/div[3]/div[9]/a[1]')).click()
        self.driver.find_element_by_xpath('//*[@id="js_contacts60"]/div/div[2]/div/div[2]/div[3]/div[1]/a[1]').click()
        sleep(20)
        self.driver.find_element_by_id('username').send_keys('pxy001')
        self.driver.find_element_by_id('memberAdd_acctid').send_keys('000')
        self.driver.find_element_by_id('memberAdd_phone').send_keys('13680586111')
